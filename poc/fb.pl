...
diagram_fact(synonym, cell_6, p7IZcTttrq__my5eBQYlH__1).
...
diagram_fact(width, cell_9, 230).
diagram_fact(x, cell_6, 140).
diagram_fact(x, cell_7, 120).
diagram_fact(x, cell_8, 460).
diagram_fact(x, cell_9, 190).
diagram_fact(y, cell_6, 80).
diagram_fact(y, cell_7, 145).
diagram_fact(y, cell_8, 145).
...
das_fact(bbL,cell_7,120).
  ...
  das_fact(bbB,cell_7,185).
das_fact(bbL,cell_8,460).
  das_fact(bbT,cell_8,145).
  das_fact(bbR,cell_8,500).
  das_fact(bbB,cell_8,185).
